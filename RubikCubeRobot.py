...
if __name__ == '__main__':
    # Motor pins
    motors_en_pin               = 26  # GPIO number for motor enable pin
    motors_base_step_pin        = 27  # GPIO number for base step pin
    motors_base_dir_pin         = 17 # GPIO number for base direction pin
    motors_arm_left_step_pin    = 19  # GPIO number for arm left step pin
    motors_arm_left_dir_pin     = 13  # GPIO number for arm left direction pin
    motors_arm_right_step_pin   = 6  # GPIO number for arm right step pin
    motors_arm_right_dir_pin    = 5  # GPIO number for arm right direction pin
    ...
    # Manual button pins
    raiseArmButton  = 24  # GPIO number for raise arm button
    lowerArmButton  = 23  # GPIO number for lower arm button
    openHandButton  = 18  # GPIO number for open hand button
    closeHandButton = 25  # GPIO number for close hand button
    spinBaseButton  = 12  # GPIO number for spin base button
