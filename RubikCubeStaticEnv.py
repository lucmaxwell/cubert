...
class RubiksCubeStaticEnv(gymnasium.Env):
    def __init__(self, num_scramble=1, cube_size=3):
        super(RubiksCubeStaticEnv, self).__init__()
    ...
    def scramble(self, num_scramble=None):
        if num_scramble is not None:
            self.current_num_scramble = num_scramble
        else:
    ...
    def reset(self, **kwargs):
        self.set_observation(self.original_obs)
        return self._get_observation(), {}
