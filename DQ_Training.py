...
from UtilityFunctions import save_model, load_model_DQN
...
if __name__ == '__main__':
    ...
    training_model = load_model_DQN(save_path, MODEL_NAME, env)

    # Before training
    training_model._logger = configure(folder="/tmp/", format_strings=["stdout"])
